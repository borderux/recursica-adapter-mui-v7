...
This document describes how to integrate and use the `FileInput` component in your projects using `@recursica/adapter-mui-v7`.
...
```tsx
import { FileInput } from "@recursica/adapter-mui-v7";
```
